...
class Event(Bean):
    ...
    def query(cls, page, limit, event_caseId):
        ...
        vs = cls.select_vs(where=where, params=params,
                           page=page, limit=limit, order='timestamp desc')
...
class EventCase(Bean):
    ...
    @classmethod
    def query(cls, page, limit, endpoint_query, metric_query, status, from_date, to_date):
        where = '1=1'
        params = []
        ...
        vs = cls.select_vs(where=where, params=params,
                           page=page, limit=limit, order='update_at desc')
        total = cls.total(where, params)
